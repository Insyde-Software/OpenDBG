...
//
// Define GDB feature control flags
//
#define GDB_INITIAL_BREAK               0x00000001
#define GDB_LOADED_MODULE_INFO_ENABLED  0x00000002
#define GDB_DEBUG_LOG_ENABLED           0x00000004
...
typedef struct _GDB_TARGET_INFO {
  CHAR8    *TargetArch;
  CHAR8    *RegistersFeature;
} GDB_TARGET_INFO;

extern GDB_TARGET_INFO  gGdbTargetInfo;
...
extern VOID    *gLoadedImageBase;
extern VOID    *gLoadedImageCodeBase;
extern CHAR8   *gLoadedImageDebugPath;
