...
{
  return ManageIdtEntryTable (PeriodicCallback, FixedPcdGet8 (PcdSystemTimerVector));
}
  ...
  )
{
  if (IdtEntryTable[ExceptionType].RegisteredCallback != NULL) {
    if (ExceptionType != FixedPcdGet8 (PcdSystemTimerVector)) {
